...
router.get("/list", protect , authorize(["admin"]),departementController.listerDepartements);
router.get("/:id",protect , authorize(["admin"]), departementController.getDepartementById);
